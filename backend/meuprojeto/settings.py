...
# Caminho base do projeto Django (backend/meuprojeto/ -> backend/)
...
INSTALLED_APPS = [
    ...
    "corsheaders",
    # Nossas apps
    "core.apps.CoreConfig",  # Forma explícita de registrar a app
]
...
LANGUAGE_CODE = "pt-br"
TIME_ZONE = "America/Sao_Paulo"  # Melhor para visualização de datas no Brasil
USE_I18N = True
USE_TZ = True  # Recomendado manter como True para armazenar datas em UTC no BD
...
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "staticfiles_build")

# Diretórios adicionais onde o Django deve procurar por arquivos estáticos
# Essencial para encontrar a pasta do seu tema 'foodmart'
STATICFILES_DIRS = [
